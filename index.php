  ...
  <div class="container-fluid">
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      <div class="row">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia eveniet saepe architecto vero fugiat distinctio ipsam error porro, totam est ab molestiae optio. 
            Veniam quam facere blanditiis dignissimos temporibus eveniet!</p>
      </div>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">Kelompok 6 Basdat</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made in  <a href="" class="text-decoration-none">kelompok 6</a>  2024</p>
        </div>
      </div>
    </footer>
